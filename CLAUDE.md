...
11. **The Work**: counter-scrolling creative wall (marquee) of real statics + muted looping video ads. Hover pauses. All assets in `assets/work/<client>/`.
12. **CTA** (dark): vertical-targeted ("If you sell windows and doors, this is your sign") + Book a Strategy Call + See All Case Studies.
